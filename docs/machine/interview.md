...
我们定义一个损失函数 $L(y, \hat{y})$ 衡量预测 $\hat{y}$ 与真实标签 $y$ 之间的差距。
学习目标是最小化期望损失：
...
![pr曲线.png](../imgs/machine/pr%E6%9B%B2%E7%BA%BF.png)
...
![决策树.png](../imgs/machine/%E5%86%B3%E7%AD%96%E6%A0%91.png)

在决策树中，我们希望选择 **最优特征** 来进行划分，让每次划分后的子集“越纯越好”。

* **纯**的意思：子集中的样本尽可能属于同一类别。
